// Note: Old sample data removed - now using real-time data from mfapi.in API
...
function filterData() {
    // Use real-time data from API instead of sample data
    let filteredData = window.realTimeSchemes ? [...window.realTimeSchemes] : [];
